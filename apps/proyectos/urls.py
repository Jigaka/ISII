...
from .views import CrearProyecto, ListarProyectos, EditarProyecto, EliminarProyecto, HistorialProyecto, \
...
urlpatterns = [
    ...
    path('historial_proyecto/<int:pk>/', HistorialProyecto.as_view(), name='historial_proyecto'),
